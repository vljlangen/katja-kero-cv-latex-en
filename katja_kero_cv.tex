...
\begin{sidebar}
    \begin{center}
		...
		{\merriweather\fontsize{22}{29}\selectfont\textcolor[HTML]{CA3346}{Vitae}}\\[2em]
        {\sourcesansbold\fontsize{8}{13}\selectfont     % Base font size here (11pt with 13pt leading)
        {\sourcesanslight\fontsize{14}{29}\selectfont 3/3}\\[2.5em]
        MD, PhD, Adjunct Professor\\[0.4em]
        Specialist in Gynecology and Obstetrics\\[0.4em]
        Psychotherapist\\[2.2em]
        {\sourcesanslight\fontsize{14}{29}\selectfont KATJA KERO}\\[2em]
...
%
\SEMIBOLD{Recipient of the Best Thesis Award in 2014}\SMALLENTER
\SEMIBOLDSMALL{Turunmaa Duodecim Medical Society}\ENTER
%
\SEMIBOLD{Teaching Act of the Year 2024: awarded for organizing the elective course} \ITALIC{"Sexuality and Gender"}
\SEMIBOLD{(Kero K, Iivanainen M, Vuorinen R, Markkanen P, and Working Group)}\SMALLENTER
\SEMIBOLDSMALL{Finnish Medical Students' Association}
